package com.dell.month_demo.common;
...
import com.dell.month_demo.R;
import com.dell.month_demo.widget.media.IRenderView;
import com.dell.month_demo.widget.media.IjkVideoView;
...
public class PlayerManager {
    ...
    public PlayerManager(final Activity activity) {
        ...
        videoView = (IjkVideoView) activity.findViewById(R.id.ijkvideo_view);
